...
// export default function CustomDateRangePicker({ borrowRequest, setBorrowRequest }) {
...
//       // Extract the start and end dates from newRange
//       const fromDate = new Date(newRange[0]);
//       const untilDate = new Date(newRange[1]);

//       // Save the selected dates in the borrowRequest state variable
//       setBorrowRequest({
//         ...borrowRequest,
